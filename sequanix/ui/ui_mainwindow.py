...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabs_pipeline.setMinimumSize(QSize(0, 200))
        ...
        self.sequana_input_dir_tab = QWidget()
        self.sequana_input_dir_tab.setObjectName(u"sequana_input_dir_tab")
        self.gridLayout_7 = QGridLayout(self.sequana_input_dir_tab)
        self.gridLayout_7.setObjectName(u"gridLayout_7")
        self.horizontalLayout_2 = QHBoxLayout()
        self.horizontalLayout_2.setObjectName(u"horizontalLayout_2")
        self.tabWidget = QTabWidget(self.sequana_input_dir_tab)
        ...
        self.layout_sequana_input_dir = QVBoxLayout()
        self.layout_sequana_input_dir.setSpacing(0)
        self.layout_sequana_input_dir.setObjectName(u"layout_sequana_input_dir")
        self.layout_sequana_input_dir.setSizeConstraint(QLayout.SetNoConstraint)
        ...
        sizePolicy3.setHeightForWidth(self.tab_generic_pipelines.sizePolicy().hasHeightForWidth())
        self.tab_generic_pipelines.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.tabs_generic.sizePolicy().hasHeightForWidth())
        self.tabs_generic.setSizePolicy(sizePolicy4)
        ...
        sizePolicy6.setHeightForWidth(self.tabs.sizePolicy().hasHeightForWidth())
        self.tabs.setSizePolicy(sizePolicy6)
        ...
        sizePolicy7.setHeightForWidth(self.snakemake.sizePolicy().hasHeightForWidth())
        self.snakemake.setSizePolicy(sizePolicy7)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 595, 211))
        ...
        sizePolicy7.setHeightForWidth(self.widget_footer.sizePolicy().hasHeightForWidth())
        self.widget_footer.setSizePolicy(sizePolicy7)
...
"")
        ...
        self.tabs_sequana.setCurrentIndex(2)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.tabs_sequana.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-weight:600;\">Left tab:</span> Select one of the pipeline in the combo box. In order to get information about a pipeline, please see the Help menu. </li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-weight:600;\">Middle tab:</span> Select one of this option</li><ol style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 2;\"><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Input directory: the directory where fastq.gz files are stored (all Sequana pipelines expect fastq.gz as input)</li><li style=\" margin-top:0px; margin-bottom:0px; mar"
                        "gin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Input samples: select one or two files (fastq.gz) in a directory</li></ol><li style=\" margin-top:0px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-weight:600;\">Right tab: </span>Select working directory where Snakefile/pipeline and config files will be copied. Pipelines are also ran in that directory. </li></ul></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.tabWidget.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Choose one of those tab as your input choice</p><p><br/></p><p><span style=\" font-weight:600;\">Left tab (Input directory):</span> Automatically select all fastq.gz files found in the directory</p><p><span style=\" font-weight:600;\">Middle tab (Input Samples):</span> Sometimes, only 1 or 2 files (paired) are required, use this tab in such situations</p><p><span style=\" font-weight:600;\">Right tab (Input pattern):</span> Your samples may be in many sub directories, or you want to select only a sub set of files. Please provide a pattern with wildcards if you use this tab</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), QCoreApplication.translate("MainWindow", u"a - Input directory", None))
        self.tabs_sequana.setTabText(self.tabs_sequana.indexOf(self.sequana_input_dir_tab), QCoreApplication.translate("MainWindow", u"2 - Input data (directory or files)", None))
        self.tabs_sequana.setTabText(self.tabs_sequana.indexOf(self.sequana_working_dir_tab), QCoreApplication.translate("MainWindow", u"3 - Working directory", None))
