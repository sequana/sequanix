...
class Ui_Snakemake(object):
    ...
    def retranslateUi(self, Snakemake):
        Snakemake.setWindowTitle(QCoreApplication.translate("Snakemake", "Snakemake options", None))
        ...
        self.snakemake_options_local_cores_label.setToolTip(
            QCoreApplication.translate(
                "Snakemake", "<html><head/><body><p>Number of CPUs to use locally.</p></body></html>", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.snakemake_options_local_cores_label.setText(QCoreApplication.translate("Snakemake", "cores", None))
        # if QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(tooltip)
        self.tabs.setTabText(self.tabs.indexOf(self.tab_local), QCoreApplication.translate("Snakemake", "&Local", None))
        # if QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(tooltip)
        self.snakemake_options_cluster_jobs_label.setText(QCoreApplication.translate("Snakemake", "jobs", None))
        ...
        # endif // QT_CONFIG(tooltip)
        self.snakemake_options_cluster_cluster_label.setText(QCoreApplication.translate("Snakemake", "cluster", None))
        # if QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(tooltip)
        self.snakemake_options_cluster_config_label.setText(
            QCoreApplication.translate("Snakemake", "cluster-config", None)
        )
        self.tabs.setTabText(
            self.tabs.indexOf(self.tab_cluster), QCoreApplication.translate("Snakemake", "&Cluster", None)
        )
        # if QT_CONFIG(tooltip)
        self.snakemake_options_general_quiet_value.setToolTip(
            QCoreApplication.translate("Snakemake", "Do not output any progress or rule information", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.snakemake_options_general_quiet_value.setText(QCoreApplication.translate("Snakemake", "Quiet", None))
        # if QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(tooltip)
        self.snakemake_options_general_forceall_value.setText(QCoreApplication.translate("Snakemake", "forceall", None))
        # if QT_CONFIG(tooltip)
        self.snakemake_options_general_keep__going_value.setToolTip(
            QCoreApplication.translate(
                "Snakemake", "<html><head/><body><p>Go on with independent jobs if a job fails.</p></body></html>", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.snakemake_options_general_keep__going_value.setText(
            QCoreApplication.translate("Snakemake", "keep-going", None)
        )
        # if QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(tooltip)
        self.snakemake_options_general_no__hooks_value.setText(QCoreApplication.translate("Snakemake", "nohooks", None))
        # if QT_CONFIG(tooltip)
        self.label_restart__times.setToolTip(
            QCoreApplication.translate("Snakemake", "Number of times to restart failing jobs (defaults to 0).", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.label_restart__times.setText(QCoreApplication.translate("Snakemake", "restart-times", None))
        # if QT_CONFIG(tooltip)
        self.snakemake_options_general_verbose_value.setToolTip(
            QCoreApplication.translate(
                "Snakemake", "<html><head/><body><p> Print debugging output.</p><p><br/></p></body></html>", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.snakemake_options_general_verbose_value.setText(QCoreApplication.translate("Snakemake", "verbose", None))
        # if QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(tooltip)
        self.snakemake_options_general_summary_value.setText(QCoreApplication.translate("Snakemake", "summary", None))
        # if QT_CONFIG(tooltip)
        self.label.setToolTip(
            QCoreApplication.translate(
                "Snakemake", "<html><head/><body><p>Add any other valid snakemake options here</p></body></html>", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.label.setText(QCoreApplication.translate("Snakemake", "any other options", None))
        self.tabs.setTabText(
            self.tabs.indexOf(self.tab_general), QCoreApplication.translate("Snakemake", "&General", None)
        )
